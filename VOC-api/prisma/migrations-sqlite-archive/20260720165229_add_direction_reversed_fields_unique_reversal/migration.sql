...
INSERT INTO "new_FinancialRecord" ("amount", "cancelReason", "cancelledAt", "cancelledById", "categoryId", "createdAt", "date", "description", "eventId", "id", "memberId", "method", "recordedById", "reversalOfId", "status", "updatedAt") SELECT "amount", "cancelReason", "cancelledAt", "cancelledById", "categoryId", "createdAt", "date", "description", "eventId", "id", "memberId", "method", "recordedById", "reversalOfId", "status", "updatedAt" FROM "FinancialRecord";
